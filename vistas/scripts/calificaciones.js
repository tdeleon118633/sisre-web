...
function init(){
   ...
   $.post("../controladores/cursos_controller.php?op=selectCursos",{idgrupo:team_id}, function(r){
   	$("#curso").html(r);
...
function verificar(id){
	...
	$.post("../controladores/calificaciones_controller.php?op=verificar",{alumn_id:id, idcurso:idcurso},
...
function listar(){
    ...
    { className: 'text-center', targets: [0,1,2,3,4] },
		...
		"ajax":
		{
			url:'../controladores/calificaciones_controller.php?op=listar',
...
function guardaryeditar(e){
     ...
     $.ajax({
     	url: "../controladores/calificaciones_controller.php?op=guardaryeditar",
     	type: "POST",
     	data: formData,
     	contentType: false,
     	processData: false,
