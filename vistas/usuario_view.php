...
<div class="box-header with-border">
  <h1 class="box-title"><i clss="fa fa-th-large"></i> Usuarios
  </h1> 
    <div class="box-tools pull-right">
    <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>i Agregar<
    <button>
  </div>
</div>
<!--box-header-->
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Nombre Completo<font color="red">*</font></label>
      <input class="form-control" type="hidden" name="idusuario" id="idusuario">
      <input class="form-control" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Nombre" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Tipo Documento<font color="red">*</font></label>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Numero de Documento<font color="red">*</font></label>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Nombre de Usuario<font color="red">*</font></label>
    ...
    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      "><i class="fa fa-archive"></i>  Guardar</button>
      <button class="btn btn-danger" onclick="cancelarform()" type="button"><i class="fa fa-save"></i> Cancelar</button>
    </div>
  </form>
</div>
<div class="panel-body" id="formulario_clave">
  <form action="" name="formularioc" id="formularioc" method="POST">
          ...
          <button class="btn btn-primary" type="submit" id="btnGuardar_clave"><i class="fa fa-archive"></i>  Guardar</button>
      <button class="btn btn-secondary" onclick="cancelarform_clave()" type="button" ><i class="fa fa-arrow-left"></i> Regresar</button>
        </form>
</div>
